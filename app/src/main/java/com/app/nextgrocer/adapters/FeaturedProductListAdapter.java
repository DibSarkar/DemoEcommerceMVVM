...
public class FeaturedProductListAdapter extends RecyclerView.Adapter<FeaturedProductListAdapter.ViewHolder>   {

    private final ArrayList<ProductListResponse.FeatureBean> mValues;

    Context mContext;
    Activity activity;
    int status;
    public ProductListListener mListener;
    public FeaturedProductListAdapter() {
    ...
    public interface ProductListListener {
        void onItemClick(ProductListResponse.FeatureBean item, int position);

    }

    public void addItems(List<ProductListResponse.FeatureBean> localBeanList) {
       mValues.clear();
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final ProductListResponse.FeatureBean mDataBean = mValues.get(position);
