...
public class CategoriesProductAdapter extends RecyclerView.Adapter<CategoriesProductAdapter.ViewHolder> {

    private final ArrayList<CategoriesProductResponse.ProductBean> mValues;
    ...
    public interface ProductListListener {
        void onItemClick(CategoriesProductResponse.ProductBean item, int position);

    }

    public void addItems(List<CategoriesProductResponse.ProductBean> newarrivalBeanList) {
        mValues.clear();
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final CategoriesProductResponse.ProductBean mDataBean = mValues.get(position);
        ...
        if (!mDataBean.getSpecial().isEmpty()) {
           ...
           // holder.tv_offer.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "bebasNeue.otf"));
            holder.tv_offer.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "fredokaOne.otf"));
